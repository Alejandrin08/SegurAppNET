...
import { FaBookReader, FaUserAltSlash } from "react-icons/fa";
...
function MenuBar() {
  ...
  return (
    <nav className="menu-nav">
      ...
      <div className="menu-section">
        <h3 className="menu-header" onClick={() => toggleSection("mechanisms")}>
          <b>
            <span className="icon-container">
      ...
      <div className="menu-section-ultimate">
        <h3 className="menu-header" onClick={() => toggleSection("appendices")}>
          <b>
            <span className="icon-container">
        ...
        {expandedSections.appendices && (
          <ul className="menu-list">
            <li
              className={`menu-item ${isActive("/glossary") ? "selected" : ""}`}
