            ...
            },
            {
              ...
              criteria: [
                ...
                },
                {
                  ...
                  achieved:
                    "Al poner en el DOM de la consola del navegador un script simple (ej. javascript:document.head.appendChild(Object.assign(document.createElement('script'),{textContent:\"alert('x')\"}))), es bloqueado y la consola del navegador reporta una violación de la CSP.",
                  notAchieved:
